      ...
      !error ? (
        !match.over ? (
          <div className="score-board-wrap">
            ...
            >
              <div
                className={`col-12 col-sm-6 flex-column px-0 border-leftplayer border ${
              ...
              >
                ...
                <div className="current-points h2 text-leftplayer">
                  {match.scores[0]}{' '}
                  {match.winner === 0 && (
              ...
              <div
                className={`col-12 col-sm-6 flex-column px-0 border-rightplayer border  ${
              ...
              >
                ...
                <div className="current-points h2 text-rightplayer">
                  {match.scores[1]}{' '}
                  {match.winner === 1 && (
                    <i className="fa fas fa-crown text-warning"> </i>
                  )}
